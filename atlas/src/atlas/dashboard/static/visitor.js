...
const ENGLISH_STRINGS = {
  ...
  "in_use.lead": "ATLAS will greet you, then you can look at an artwork and begin your conversation. This kiosk has cleared your name.",
...
async function startExperience() {
  ...
  try {
    ...
    await api("/api/visitor/onboarding/start", {
      method: "POST",
      body: JSON.stringify({ greeting_name: visitor.firstName || null }),
    });
