...
try {
    ...
    $remoteCommand = $remoteCommand.Replace(
        "/static/visitor/assets/atlas-logo-v2.webp /static/visitor/assets/expertise-mona.webp /static/visitor/assets/stories.svg",
        "/static/visitor/assets/atlas-logo-v2.webp /static/visitor/assets/gallery-mona-lisa.webp /static/visitor/assets/gallery-great-wave.webp /static/visitor/assets/gallery-ambassadors.webp /static/visitor/assets/stories.svg"
    )
